  ...
  const handleSignIn = async (e) => {
    ...
    <div className="flex flex-col justify-center">
      <div className="rounded-lg bg-white w-80 text-center p-2 h-max px-4">
        ...
        <InputBox onChange={(e)=>{setUsername(e.target.value)}} placeholder="vishnu@gmail.com" label={"Username"} />
        <InputBox onChange={(e)=>{setPassword(e.target.value)}} placeholder="abc123@8" label={"Password"} />
        <div className="pt-4">
